...
function main () {
  ...
  <section className="head-section">
    <span className="head-section__content-wrapper">
      ...
      <p className="head-section__text">6 Suggestions</p>
    </span>
    <div className="head-section__filter-wrapper">
      <p className="head-section__filter-text">Sort by:</p>
      <select className="head-section__select" name="select">
        <option className="head-section__option" value="Most Upvotes">Most Upvotes</option>
        <option className="head-section__option" value="Least Upvotes">Least Upvotes</option>
        <option className="head-section__option" value="Most Comments">Most Comments</option>
        <option vclass="head-section__option" alue="Least Comments">Least Comments</option>
      </select>
    </div>
    <button className="head-section__add-btn">+ Add Feedback</button>
  </section>
  <section className="hero-section">
    <ul className="hero-section__cards">
      <li className="hero-section__card">
        <button className="hero-section__card-btn">
          <svg width={11} height={7} viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.33447 6L5.33447 2L9.33447 6" stroke="#4661E6" strokeWidth={2} />
          </svg>
          <p className="hero-section__card-btn-num">0</p>          
        </button>
        <div className="hero-section__card-content-wrapper">
          <h2 className="hero-section__card-title">Add tags for solutions</h2>
          <p className="hero-section__card-text">Easier to search for solutions based on a specific stack.</p>
          <p className="hero-section__card-sort">Bug</p>
        </div>
        <span className="hero-section__comment-wrapper">
