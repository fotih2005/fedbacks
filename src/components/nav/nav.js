...
const Nav = () => {
    ...
    <nav className="site-nav">
        ...
        <ul className="site-nav__cards">
            ...
            <label className="site-nav__card-input" htmlFor="all">All</label>
            </li>
            <li className="site-nav__card">
            <input className="sita-nav__checked-input" type="radio" id="ui" />
            <label className="site-nav__card-input" htmlFor="ui">UI</label>
            </li>
            <li className="site-nav__card">
            <input className="sita-nav__checked-input" type="radio" id="ux" />
            <label className="site-nav__card-input" htmlFor="ux">UX</label>
            </li>
            <li className="site-nav__card">
            <input className="sita-nav__checked-input" type="radio" id="Enhancement" />
            <label className="site-nav__card-input" htmlFor="Enhancement">Enhancement</label>
            </li>
            <li className="site-nav__card">
            <input className="sita-nav__checked-input" type="radio" id="bug" defaultChecked />
            <label className="site-nav__card-input" htmlFor="bug">Bug</label>
            </li>
            <li className="site-nav__card">
            <input className="sita-nav__checked-input" type="radio" id="feature" />
            <label className="site-nav__card-input" htmlFor="feature">Feature</label>
            </li>
        </ul>
        <div className="sita-nav__roadmap">
            ...
            <a className="site-nav__roadmap-link" href="#">View</a>
            </span>
